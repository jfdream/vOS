...
class MainActivity : LoadingActivity() {
    ...
    private fun getPrivilege() {
        ActivityCompat.requestPermissions(
            this@MainActivity,
            arrayOf(Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission_group.MICROPHONE, Manifest.permission.READ_EXTERNAL_STORAGE),
            200
        )
    }
